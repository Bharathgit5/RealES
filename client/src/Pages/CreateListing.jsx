...
const handleSubmit =async (e) =>{
    e.preventDefault();
 try{
    if(formData.imageUrls.length < 1) return setError('Please upload atleast one image');
    ...
    <main className='p3 max-w-4xl mx-auto'>
        ...
        <div className='flex flex-wrap gap-6'>
         ...
         <div className='flex items-center gap-2'>
          ...
          <div className='flex items-center gap-2'>
            <input type="number" id='regularPrice' min='10' max='1000' required 
...
{formData.offer && (
            ...
            uppercase hover:opacity-80 mt-5'>{loading ? 'Creating...' : 'Create listing' }</button>
